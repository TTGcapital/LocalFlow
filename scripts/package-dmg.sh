#!/bin/zsh
# Packages build/LocalFlow.app into a distributable .dmg.
#
...
# wherever the browser downloaded it, which is how you end up running LocalFlow
...
codesign --verify --strict "$MOUNT/LocalFlow.app"
