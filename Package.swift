...
// The portable half of LocalFlow, as a package that builds anywhere Swift runs.
//
...
let package = Package(
    ...
    targets: [
        .target(name: "LocalFlowCore", path: "Sources/Core"),
        .testTarget(name: "LocalFlowCoreTests", dependencies: ["LocalFlowCore"], path: "Tests/Core"),
    ]
)
